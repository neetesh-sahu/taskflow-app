...
const PROFILE_PHOTO_KEY = "taskflow_profile_photo";
      ...
      {tab === "profile" && (
        <section className="tf-card settings-profile">
          ...
          <div className="settings-avatar">
            <div className="settings-avatar-photo">
              <Avatar
                name={name || "Neetesh"}
                size="large"
                photo={profilePhoto}
        ...
        <section className="tf-card">
          <div className="tf-card-head">
            <div>
              ...
              <p>Switch between TaskFlow visual styles.</p>
            </div>
            <Palette size={20} />
          </div>
        ...
        <section className="tf-card security-card">
          <div className="tf-card-head">
            <div>
              ...
              <p>Your session and account protection.</p>
            </div>
            <Shield size={20} />
          </div>
        ...
        <section className="tf-card">
          <div className="tf-card-head">
            <div>
              ...
              <p>Connect your workflow tools here.</p>
            </div>
            <Zap size={20} />
          </div>
          ...
          <div className="security-row">
            ...
            <div>
              <strong>TaskFlow API</strong>
              <span>Core task, profile and workspace services are connected.</span>
            </div>
            <span className="secure-badge">Connected</span>
          </div>
        </section>
      )}
    </div>
...
function App() {
  ...
  const openProfile = (section = "profile") => {
    setPage("Settings");

    // Store the requested settings section for the Settings page.
    window.dispatchEvent(
      new CustomEvent("taskflow-settings-tab", {
        detail: section,
      })
    );
  };
